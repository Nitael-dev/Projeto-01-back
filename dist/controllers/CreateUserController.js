...
var CreateUserController = /** @class */ (function () {
    ...
    CreateUserController.prototype.handle = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var newUser, createUserService, passwordTryUser, password, rest;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newUser = req.body;
                        createUserService = new CreateUserService_1.CreateUserService();
                        return [4 /*yield*/, createUserService.execute(newUser, res)];
                    case 1:
                        passwordTryUser = _a.sent();
                        password = passwordTryUser.password, rest = __rest(passwordTryUser, ["password"]);
