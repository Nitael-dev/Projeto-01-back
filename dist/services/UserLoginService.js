...
var UserLoginService = /** @class */ (function () {
    ...
    UserLoginService.prototype.execute = function (_a, res) {
        var email = _a.email, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var usersRepository, userAccountExists, passwordAuthetication, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, bcrypt.compare(password, userAccountExists.password)];
                    case 2:
                        passwordAuthetication = _b.sent();
                        if (!passwordAuthetication) {
                            return [2 /*return*/, res.status(403).json({
                                    message: "Senha incorreta. Tente novamente ou clique em 'Esqueceu a senha?' para redefini-la."
                                })];
                        }
                        return [2 /*return*/, res.status(200).json(userAccountExists)];
                    case 3:
                        error_1 = _b.sent();
